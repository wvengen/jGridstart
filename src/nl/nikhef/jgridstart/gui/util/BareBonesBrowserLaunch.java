 ...
 * <p>
 * This code is an adaptation of <a href="http://www.centerkey.com/java/browser/">http://www.centerkey.com/java/browser/</a>
 */
public class BareBonesBrowserLaunch {
	...
	try {
	    ...
	    String out = "";
	    if (FileUtils.Exec(cmd, out)!=0)
		throw new Exception("Error opening page: "+out);
	}
	catch (Exception e) {
    ...
    /** Open a URL
     * <p>
     * This is equal to {@link #openURL(URL, Component) openURL(url, null)} so any error dialog will have no parent.
     * 
     * @param url {@link URL} to open
     */
    ...
    /** Open a string URL
     * <p>
     * This is equal to {@link #openURL(String, Component) openURL(surl, null)} so any error dialog will have no parent.
     * 
     * @param surl URL to open (as String)
     */
