...
BASE=`dirname $0`
LIB="$BASE/thirdparty"
CLASSPATH="$LIB/bouncycastle/bcprov-jdk14-143.jar:$LIB/commons-cli/commons-cli-1.2.jar:$LIB/flyingsaucer/core-renderer-minimal.jar:$LIB/flyingsaucer/iText-2.0.8.jar:$LIB/swingworker/swing-worker-1.2.jar:$BASE/bin"
INVOKED_PROGRAM="$0"
