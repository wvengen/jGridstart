...
mvn -B -q exec:java -Dexec.mainClass="nl.nikhef.jgridstart.gui.Main" -Dexec.args="`echo $@`" -Djgridstart.requestwizard.provider=nl.nikhef.jgridstart.ca.dutchgrid.RequestWizard $EXTRAARGS
